...
from skillpod.shared.utils import normalize_token, parse_frontmatter
...
class IndexStore:
    ...
    def _canonical_metadata(
        ...
        if tags is not None:
            skillpod["tags"] = tags
        skillpod["alwaysApply"] = bool(
            skillpod.get("alwaysApply", skillpod.get("always_apply", always_apply))
        )
    ...
    def initialize_index(self) -> None:
        ...
        for skill_path in _iter_skill_dirs(skills_dir):
            ...
            always_apply = skillpod_meta.get(
                "alwaysApply", skillpod_meta.get("always_apply", False)
            )
